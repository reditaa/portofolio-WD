<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-8">
                ...
                <form method="POST" action="{{ route('project.update', $project->id) }}" enctype="multipart/form-data" class="space-y-6" id="editProjectForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        @if($project->image)
                            <div class="mb-4">
                                ...
                                <img src="{{ asset('storage/'.$project->image) }}" alt="{{ $project->title }}" class="max-w-xs rounded-lg border border-gray-200">
                            </div>
                        @endif
                        <label class="block text-sm text-gray-600 dark:text-gray-400 mb-2">Ubah gambar (opsional):</label>
    ...
    <script>
        ...
        // Optional: redirect dengan alert setelah submit via AJAX
        const form = document.getElementById('editProjectForm');
        form.addEventListener('submit', function(e){
            // bisa ditambah AJAX di sini kalau mau live submit tanpa reload
        });
    </script>
</x-app-layout>